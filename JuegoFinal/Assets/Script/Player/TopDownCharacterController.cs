...
public class TopDownCharacterController : MonoBehaviour
{
    ...
    private Vector2 GetMovementDirection()
    {
        ...
        // Aquí va el código existente para obtener la dirección de movimiento
        // desde las teclas y actualizar el Animator y la dirección de ataque

        // Verificar si alguna tecla está presionada
        if (Input.GetKey(KeyCode.W) || Input.GetKey(KeyCode.A) || Input.GetKey(KeyCode.S) || Input.GetKey(KeyCode.D) ||
            Input.GetKey(KeyCode.UpArrow) || Input.GetKey(KeyCode.LeftArrow) || Input.GetKey(KeyCode.DownArrow) || Input.GetKey(KeyCode.RightArrow))
        {
            if (!animationController.GetIsMoving())
            {
                animationController.SetIsMoving(true);
                // Si S o flecha abajo presionada
                if (Input.GetKey(KeyCode.S) || Input.GetKey(KeyCode.DownArrow))
                {
                    animationController.SetAttackDirection(0);
                    direction.y = -1;
                    direction.x = 0;
                    attackDirection = 0;
                ...
                {
                    animationController.SetAttackDirection(2);
                    direction.x = 1;
                    direction.y = 0;
                    attackDirection = 2;
                }
                ...
                {
                    animationController.SetAttackDirection(3);
                    direction.x = -1;
                    direction.y = 0;
                    attackDirection = 3;
                }
                ...
                {
                    animationController.SetAttackDirection(1);
                    direction.y = 1;
                    direction.x = 0;
                    attackDirection = 1;
                }
    ...
    {
        // Aquí va el código existente para verificar si se han soltado las teclas de dirección
        // y actualizar la dirección y las animaciones en consecuencia
