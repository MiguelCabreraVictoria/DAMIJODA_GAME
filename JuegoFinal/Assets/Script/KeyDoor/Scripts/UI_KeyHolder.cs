...
public class UI_KeyHolder : MonoBehaviour {
    ...
    private void UpdateVisual() {
        ...
        for (int i = 0; i < keyList.Count; i++) {
            ...
            switch (keyType) {
            default:
            case Key.KeyType.Boss:   keyImage.color = Color.yellow;     break;
            //case Key.KeyType.Green: keyImage.color = Color.yellow;   break;
            //case Key.KeyType.Blue:  keyImage.color = Color.yellow;    break;
            }
        }
    }
